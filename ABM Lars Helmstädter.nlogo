...
to go2
  let stop-simulation false
  while [not stop-simulation] [
    tick
    if Budget_Germany <= 0 and Budget_Spain <= 0 [
      create-End_of_Simulations 1 [
        set color green
      ...
      print round (Budget_Spain * 100) / 100
      print round (sum [Total_Score] of Applicant_Ss / count Applicant_Ss * 100) / 100
      print round (sum [Total_Score] of Applicant_Ss * 100) / 100
      print count Applicant_Ss with [Total_Score > Threshold]
      print ticks
      print "Insufficient Budget"
...
to go2both
  ...
  while [not stop-simulation] [
    ...
    if Budget_Germany <= 0 and Budget_Spain <= 0 [
      ...
      print round (sum [Total_Score] of Applicant_Ss * 100) / 100
      print count Applicant_Ss with [Total_Score > Threshold]
      print round (Budget_Germany * 100) / 100
      print round (sum [Total_Score] of Applicant_Gs / count Applicant_Gs * 100) / 100
      print round (sum [Total_Score] of Applicant_Gs * 100) / 100
      print count Applicant_Gs with [Total_Score > Threshold]
      print ticks
      print "Insufficient Budget"
      set stop-simulation true
    ]
